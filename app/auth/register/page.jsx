        ...
        <>
          <div className="fixed right-0 left-0 top-0 bottom-0 px-[10px] flex justify-center overflow-auto">
            <div className="mobile:w-[40%] w-full">
              ...
              <div className="w-full flex justify-center">
                <button
                  className="w-[300px] flex justify-center items-center h-[40px] bg-[#3772FF] rounded-[12px] text-white font-abeezeeItalic hover:bg-opacity-70 transition-all duration-100"
                  onClick={async () => {
                    setLoading(true);
                    await getUser();
                    router.push("/home");
