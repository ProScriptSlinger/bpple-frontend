      ...
      <div className=" text-[14px] w-full flex items-center justify-center h-full">
        <div className=" w-full z-2 relative py-20 max-w-[350px] p-10 mx-auto bg-[#181818]/50 backdrop-blur-xl items-center  rounded-3xl  border  border-[#393939]">
          ...
          <button
            ...
            disabled={joining}
            className={`w-full  flex items-center justify-center font-abeezeeItalic disabled:bg-[#282828] bg-[#3772FF] disabled:text-[#6D6D6D] text-white mt-[20px] text-[15px] rounded-[15px] font-bold py-[15px] relative transition-all duration-300 hover:bg-opacity-[70%]`}
          >
            {joining ? (
